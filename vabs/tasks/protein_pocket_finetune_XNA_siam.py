...
@register_task("protein_pocket_ft_XNA_siamdiff")
class siamdiffProteinftTask(UnicoreTask):
    @staticmethod
    def add_args(parser):
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        is2re_dataset = siamdiffPocketDataset(
        ...
        res_mask = AtomPosDataset(is2re_dataset, "res_mask")
